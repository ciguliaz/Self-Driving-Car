class World {
    ...
    static load(info) {
        ...
        world.roadRouness = info.roadRouness;
    ...
    generate() {
        ...
        for (const seg of this.graph.segments) {
            this.envelopes.push(
                new Envelope(seg, this.roadWidth, this.roadRouness)
            )
        }
    ...
    #generateTrees() {
        ...
        while (tryCount < 100) {
            ...
            // check tree inside road or building or too close
            let keep = true;
            ...
            // check if tree generate too far away
            if (keep) {
    ...
    #updateLights() {
        ...
        for (const light of lights) {
            ...
            // console.log(point, light.center, this.#getIntersections())
